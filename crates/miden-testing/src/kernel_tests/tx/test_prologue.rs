...
use miden_protocol::account::{
    Account, AccountBuilder, AccountId, AccountIdVersion, AccountProcedureRoot, AccountStorage,
...
use miden_protocol::transaction::memory::{
    ...
    INIT_NATIVE_ACCT_STORAGE_COMMITMENT_PTR, INIT_NATIVE_ACCT_VAULT_ROOT_PTR, INIT_NONCE_PTR,
    ...
    INPUT_NOTES_COMMITMENT_PTR, KERNEL_PROCEDURES_PTR, NATIVE_ACCT_CODE_COMMITMENT_PTR,
    NATIVE_ACCT_ID_AND_NONCE_PTR, NATIVE_ACCT_ID_PTR, NATIVE_ACCT_PROCEDURES_SECTION_PTR,
    ...
    PARTIAL_BLOCKCHAIN_PEAKS_PTR, PREV_BLOCK_COMMITMENT_PTR, PROTOCOL_VERSION_IDX, TIMESTAMP_IDX,
    TX_COMMITMENT_PTR, TX_KERNEL_COMMITMENT_PTR, TX_SCRIPT_ROOT_PTR, VALIDATOR_KEY_COMMITMENT_PTR,
